...
const Projects = () => {
  const { trackSectionVisit, trackProjectView } = useAchievements()
            ...
            >
              ...
              <div className="project-image">
                <img
                  ...
                  onError={(e) => {
                    e.target.src = `data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="400" height="200" viewBox="0 0 400 200"><rect width="400" height="200" fill="%23f3f4f6"/><text x="200" y="100" text-anchor="middle" dy=".3em" fill="%236b7280" font-family="Arial" font-size="16">${project.title}</text></svg>`;
                  }}
                />
