...
import ShakeOnHover from './ShakeOnHover'
import './Navbar.css'
    ...
    <nav className={`navbar ${isScrolled ? 'scrolled' : ''}`}>
      <div className="nav-container">
        ...
        <div className="nav-brand">
          <h1 className="brand-text">Jivanshu</h1>
        </div>

        {/* Desktop Navigation */}
        <div className="nav-links desktop-nav">
          <button onClick={() => handleScroll('home')} className="nav-link">About</button>
        ...
        {/* Theme Toggle, Sound Toggle & Social Links */}
