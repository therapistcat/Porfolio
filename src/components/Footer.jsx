        ...
        <div className="footer-content">
          ...
          <div className="footer-brand">
            ...
            <div className="social-links">
              ...
              <a href="https://www.linkedin.com/in/jivanshu-mishra" target="_blank" rel="noopener noreferrer" className="social-link">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="mailto:jivanshu@example.com" className="social-link">
          ...
          <div className="footer-links">
            ...
            <ul className="links-list">
              <li><button onClick={() => handleScroll('home')} className="footer-link">About</button></li>
              <li><button onClick={() => handleScroll('skills')} className="footer-link">Skills</button></li>
              <li><button onClick={() => handleScroll('projects')} className="footer-link">Projects</button></li>
            </ul>
          </div>
          ...
          <div className="footer-contact">
            ...
            <div className="contact-info">
              <a href="mailto:jivanshu@example.com" className="contact-email">
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                jivanshu@example.com
              </a>
